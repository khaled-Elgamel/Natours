    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          return _context.abrupt("return", res.data.data.user);
        case 8:
          _context.next = 13;
          break;
        case 10:
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51RBUTdQPL4afr17Gov0CdpyqlxrRzbPXGtGL3OxCNLC2NwcP4zCPCZboDhvkQPar6pVDAe2KEpHVRu08e1fq9lN500pCQzo6uV'); // 1) Get checkout session from API
          _context.next = 4;
...
if (userDataForm) {
  userDataForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var form, updatedUser, profileImgNav, profileImg;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
          ...
          case 7:
            ...
            // If successful, update the photo src from the server path
            if (updatedUser && updatedUser.photo) {
              profileImgNav = document.querySelector('.nav__user-img');
              profileImg = document.querySelector('.form__user-photo');
              profileImg.src = profileImgNav.src = "/img/users/".concat(updatedUser.photo);
            }
          case 9:
          case "end":
            return _context.stop();
